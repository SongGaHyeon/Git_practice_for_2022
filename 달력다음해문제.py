...
'''
for문을 사용해서 사이 년도를 다 돌아야하는데, 해당 년도가 윤년인지 아닌지에 따라 더하는 수가 달라진다. 따라서 윤년을 구하는 함수를 만들어서 사용하였당.
'''
print("오늘은 금요일입니다.")
...
year=list(map(int,sys.stdin.readline().rstrip().split())) #input 보다 이게 수행시간이 더 적게 걸린다고 합니다.
